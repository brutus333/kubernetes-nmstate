...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NMStateSelfSignConfiguration) DeepCopyInto(out *NMStateSelfSignConfiguration) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NMStateSelfSignConfiguration.
func (in *NMStateSelfSignConfiguration) DeepCopy() *NMStateSelfSignConfiguration {
	if in == nil {
		return nil
	}
	out := new(NMStateSelfSignConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NMStateSpec) DeepCopyInto(out *NMStateSpec) {
	*out = *in
	...
	out.SelfSignConfiguration = in.SelfSignConfiguration
}
